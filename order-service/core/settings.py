...
DATABASES = {
    "default": {
        ...
        "NAME":     env("DB_NAME",     default="order_db"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "E-Commerce Order Microservice",
    "VERSION": "1.0.0",
...
# ─── External Services ────────────────────────────────────────────────────────
PRODUCT_SERVICE_URL = env("PRODUCT_SERVICE_URL", default="http://product-service:8001")
CART_SERVICE_URL = env("CART_SERVICE_URL", default="http://cart-service:8002")
PAYMENT_SERVICE_URL = env("PAYMENT_SERVICE_URL", default="http://payment-service:8004")
SHIPPING_SERVICE_URL = env("SHIPPING_SERVICE_URL", default="http://shipping-service:8005")
